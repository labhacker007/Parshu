...
def export_report_pdf(
    ...
    company_name = branding.get('company_name', 'HuntSphere Security')
    ...
    report_footer = branding.get('report_footer', 'Generated by HuntSphere Threat Intelligence Platform')
    ...
    disclaimer_box = Table(
        [[Paragraph(
            f"<b>DISCLAIMER:</b> This report was generated by {company_name} using the HuntSphere Threat Intelligence Platform. "
    ...
    filename = f"HuntSphere_Report_{safe_title}_{date_str}.pdf"
...
<body>
  ...
  <footer>
    ...
    <div class="footer-text">{company_name} • Threat Intelligence Report • Generated by HuntSphere</div>
  </footer>
</body>
</html>'''
